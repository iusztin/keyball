...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  RSFT_T(KC_ENT) ,
                  KC_LGUI, KC_LALT, KC_MEH, MO(1), KC_SPC,    KC_BSPC, MO(2), _______, _______, KC_HYPR
  ),
  ...
  [4] = LAYOUT_universal(
    ...
    SSNP_VRT, _______, _______, _______, _______, _______,            KC_PGUP, KC_BTN1, KC_BTN2, KC_BTN3, _______, _______,
    SSNP_HOR, _______, _______, _______, _______, _______,            KC_PGDN, KC_BTN4, KC_BTN5, _______, _______, _______,
                  _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______
  ),
...
layer_state_t layer_state_set_user(layer_state_t state) {
    // Auto enable scroll mode when layer 1 is on
    keyball_set_scroll_mode(layer_state_cmp(state, 1));

    // Enable layer 3 when layers 1 & 2 are active
