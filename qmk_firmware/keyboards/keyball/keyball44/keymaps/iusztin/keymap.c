...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  RSFT_T(KC_ENT) ,
                  KC_HYPR, KC_MEH, KC_LGUI, MO(2), KC_SPC,    KC_BSPC, MO(3), _______, _______, KC_LALT
  ),

  [1] = LAYOUT_universal(
    _______, _______, _______, _______, _______, _______,            _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,            SCRL_TO, KC_BTN1, KC_BTN2, KC_BTN3, _______, _______,
    _______, _______, _______, _______, _______, _______,            SCRL_MO, KC_BTN4, KC_BTN5, _______, _______, _______,
